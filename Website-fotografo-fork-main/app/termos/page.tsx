...
function SectionCard({ section }: { section: TermSection }) {
  return (
...
export default async function TermosDeUsoPage() {
  ...
  try {
    ...
    if (!termo) notFound()
    versao = termo.versao
    sections = JSON.parse(termo.conteudo) as TermSection[]
  } finally {
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[35vh] md:min-h-[45vh] flex items-center justify-center bg-neutral-50 overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-4 md:space-y-5 px-4 sm:px-6">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-normal text-foreground leading-[0.95] text-balance">Termos de Uso</h1>
          <p className="text-sm md:text-lg text-muted-foreground max-w-lg mx-auto leading-relaxed">Leia com atenção as condições que regem o uso da plataforma e a contribuição de imagens culturais maranhenses.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6 md:gap-10">
            ...
            <div className="flex flex-col gap-5 md:gap-6">
              ...
              <div className="bg-neutral-900 rounded-[1.5rem] md:rounded-[3rem] p-6 md:px-10 md:py-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5 md:gap-6 mt-4">
                <div>
                  <h3 className="font-serif text-xl md:text-2xl text-white mb-1">Dúvidas sobre os termos?</h3>
